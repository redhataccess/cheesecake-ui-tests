...
module_display_page_path_after_published = "pantheon/#/module/repositories/uploader-sample-repo-pantheon2/entities/enterprise/modules/cockpit/con_pretty-host-name-in-the-web-console.adoc?variant=variant1-uploader"
